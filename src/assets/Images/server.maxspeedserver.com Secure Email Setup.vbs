' server.maxspeedserver.com Secure Email Setup.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "server.maxspeedserver.com"		 					' This is the address for the mail server
strOutServerAddress	   = "server.maxspeedserver.com"		 					' This is the address for the mail server
...
strAccount			   = "tarunsurana@cryptocurrency-list.co.in"							' Mail account to connect as
